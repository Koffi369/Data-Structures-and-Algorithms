...
int main(){
    ...
    array<int,5> myarr = {1,2,3,4};

    cout <<  "myarr.begin():  " <<  myarr.begin() << endl;
    cout << "*myarr.begin():  " << *myarr.begin() << endl;
    cout << "myarr.end():  " << myarr.end() << endl;
    cout << "*myarr.end():  "   << *myarr.end() << endl;
    ...
    cout <<  "myarr.empty():  " <<  myarr.empty() << endl;
    cout <<  "myarr.at(0):  " <<  myarr.at(0) << endl;
...
// g++ -std=c++17 code9.cpp -o code9
// Execute it with ./code9
