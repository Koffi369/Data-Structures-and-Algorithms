...
int main(){
    ...
    cout << "Min value of float is "<< numeric_limits<float>::min() << endl;
    cout << "Max value of float is "<< numeric_limits<float>::max() << endl;


    cout << "Min value of double is "<< numeric_limits<double>::min() << endl;
    cout << "Max value of double is "<< numeric_limits<double>::max() << endl;




    // float has 6 point precision but double has 15 point precision


    float float1 = 1.11111111;
    float float2 = 1.11111111;

    float float3 = float1 + float2;

    printf("the 10 decimal Precision of float3 is %.10f \n", float3);



    double  double1 = 1.1111111111111111;
    double double2 = 1.1111111111111111;

    double double3 = double1 + double2;

    printf("the 20 decimal Precision of double3 is %.20f \n", double3);
...
// g++ -std=c++17 code2.cpp -o code2
// Execute it with ./code2 
